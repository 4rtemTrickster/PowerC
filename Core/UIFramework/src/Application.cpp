...
UI::Application* s_instance = nullptr;
...
Application::Application(const ApplicationSpec& application_spec)
    : m_spec(application_spec)
{
    s_instance = this;
...
void Application::init()
{
    ...
    m_window_handle = glfwCreateWindow(m_spec.width, m_spec.height, m_spec.name.c_str(), NULL, NULL);
    ...
    VkResult err = glfwCreateWindowSurface(g_Instance, m_window_handle, g_Allocator, &surface);
    check_vk_result(err);
    ...
    ImGui_ImplGlfw_InitForVulkan(m_window_handle, true);
